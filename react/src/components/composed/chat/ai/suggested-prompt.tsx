...
export function SuggestedPrompt({
  ...
  return (
    <motion.button
      className={cn(
        "group/prompt flex w-full cursor-pointer items-center gap-2 rounded-md px-2 py-1 text-left text-sm text-foreground/90 transition-colors duration-150 ease-smooth-out outline-none hover:bg-foreground/5 focus-visible:bg-foreground/5 disabled:cursor-not-allowed disabled:opacity-50",
        className
      )}
    ...
    >
      <Sparkle
        aria-hidden="true"
        className="size-3.5 shrink-0 fill-violet-500/30 stroke-violet-600 stroke-[1.5] dark:fill-violet-400/20 dark:stroke-violet-400"
      />
