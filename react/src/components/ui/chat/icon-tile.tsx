...
export interface IIconTileProps extends React.ComponentPropsWithoutRef<"span"> {
 ...
 */
export function IconTile({ size = 40, tone = "neutral", className, children, ...props }: IIconTileProps): React.ReactElement {
  return (
    <span
      data-slot="icon-tile"
      className={cn(
