...
export interface IWaveformProps extends React.ComponentPropsWithoutRef<"span"> {
 ...
 */
export function Waveform({ bars = DEFAULT_BARS, progress = 0, className, ...props }: IWaveformProps): React.ReactElement {
  return (
